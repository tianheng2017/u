                            ...
                            <div class="col s12">
                                ...
                                <table class="striped" style="border: 1px solid #bdbdbd;">
                                    ...
                                    <tr>
										...
										<th data-field="">姓名</th>
										<th data-field="">上级</th>
										<th data-field="">余额（<{PFCOINNAME}>）</th>
										<!--th data-field="">额度（<{PFCOINNAME}>）</th>
                                    ...
                                    <tr class="usertr<{$datai['id']}>">
										...
										<td class="tdtcenter"><{$datai['superiorusername']}></td>
										<td class="tdtcenter"><{$datai['money']}></td>
										<!--td class="tdtcenter"><{$datai['money2']}></td>
										<td class="tdtcenter"><{$datai['allinvestment']}></td>
										
										
										
										<td class="tdtcenter"><{$datai['proportion']}>%</td>
										<td class="tdtcenter"><{$datai['proportionp']}>%</td-->
                                        <td class="tdtcenter"><{$datai['auto_ratiopn']}></td>
										
										
										<td class="tdtcenter"><{$datai['coinaddress']}></td>
										...
										<td class="tdtcenter"><{$datai['remarks']}></td>
										
										
										<td class="tdtcenter fontcolorb6b6b6 fontweight100"><{$datai['regtime']}></td>
                                        ...
                                        <td class="tdtcenter">
											...
											<a style="display:none;" href="<{WSURLSHOW($WsCtrlClass,'userlogin')}>/id/<{$datai['id']}>/" target="_blank" class="btn cyan">模拟登录</a>
											
											<div style="display:none;" onclick="uppasidM('<{$datai['id']}>')" class="purple lighten-2 waves-effect waves-light btn modal-trigger  light-blue" href="#modal1">修改密码</div>

											<a href="<{WSURLSHOW($WsCtrlClass,'upuserinfo')}>/id/<{$datai['id']}>/" class="purple lighten-2 waves-effect waves-light btn modal-trigger  light-blue">用户编辑</a>			
											
											
											<div onclick="sendmoneyidM('<{$datai['id']}>')" class="orange darken-1 waves-effect waves-light btn modal-trigger  light-blue" href="#modal3">后台充值</div>			
											
											
											<{if $datai['state']==1}>
											<div onclick="upstopM('<{$datai['id']}>')" class="btn">点击冻结</div>
											<{else}>
											<div onclick="upstopM('<{$datai['id']}>')" class="btn cyan">点击解冻</div>
											<{/if}>
