<?php
/* Smarty version 3.1.30, created on 2020-05-01 14:34:57
  from "E:\u.xiangxin.me\app\views\admin_v1\adminuser_slideedit.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5eabc311462cc9_67616987',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9c371f91cd9f2c5b2ec5cca078d3de4caf8dbd3b' => 
    array (
      0 => 'E:\\u.xiangxin.me\\app\\views\\admin_v1\\adminuser_slideedit.tpl',
      1 => 1577718834,
      2 => 'file',
    ),
  ),
...
function content_5eabc311462cc9_67616987 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
" type="text">
                                                ...
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="password" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['type'];?>
" name="type" type="text">
                                                    <label for="password">类型：1.中文 2.英文</label>
                                                </div>	
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['img'];?>
" name="img" type="text">
                                                    <label for="passwordtwo">图片地址</label>
                                                </div>
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['status'];?>
...
>
 ...
 type="text/javascript">
        $(".btnvideoadd").click(function () {
            ...
            var options = {
                url: "<?php echo WSURLSHOW($_smarty_tpl->tpl_vars['WsCtrlClass']->value,'slideedit_do');?>
",
                type: 'post',
                dataType: 'text',
