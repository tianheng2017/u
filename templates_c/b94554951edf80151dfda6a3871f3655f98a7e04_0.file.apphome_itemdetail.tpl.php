<?php
/* Smarty version 3.1.30, created on 2020-05-04 22:00:08
  from "E:\u.xiangxin.me\app\views\app_cn_v1\apphome_itemdetail.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5eb01fe8bb1675_43628427',
...
function content_5eb01fe8bb1675_43628427 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div style="padding:10px 15px 25px;">
					...
					<div style="font-size: 15px;color: #727679;height: 100px;padding-top: 25px;">
						<ul class="time-horizontal">
							...
							<li>
								<b></b>
								<span style="font-size: 14px;"><?php echo $_smarty_tpl->tpl_vars['time1']->value;?>
</span>
					...
					<div>
						<ul class="ul2">
							<li>存入后不可撤销，到期前不可取出</li>
							<li>收益规则：当日存入，次日确认后开始计息</li>
							<li>取出时间：项目到期后，本金+利息自动转入用户余额</li>
