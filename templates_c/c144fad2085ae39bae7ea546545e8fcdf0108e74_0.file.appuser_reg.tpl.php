<?php
/* Smarty version 3.1.30, created on 2020-05-01 16:21:35
  from "E:\u.xiangxin.me\app\views\app_cn_v1\appuser_reg.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5eabdc0f7b8215_45993592',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c144fad2085ae39bae7ea546545e8fcdf0108e74' => 
    array (
      0 => 'E:\\u.xiangxin.me\\app\\views\\app_cn_v1\\appuser_reg.tpl',
      1 => 1578286780,
      2 => 'file',
    ),
  ),
...
function content_5eabdc0f7b8215_45993592 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo VIEW_ROOTPATH;?>
/assets/public/codrops/css/style.css" />
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo VIEW_ROOTPATH;?>
/assets/public/codrops/js/modernizr.custom.79639.js"><?php echo '</script'; ?>
>
...
/assets/wap/images/logo2.png" style="margin: 0;display:none;" class="logo-img">
						...
						<form action="#" id="form_post" name="form_post" method="post">
							<ul>
								<li class="item-content item-input">
									<div class="item-inner">
										<div class="item-input-wrap">
											...
											<input style="display:inline-block;float:left;width:55%;margin-left: 5%;" id="username" type="text" name="username" placeholder="手机号">
										</div>
									</div>
								</li>
								...
								<li class="item-content item-input">
									<div class="item-inner">
										<div class="item-input-wrap">
											<input id="superioruid" type="text" name="superioruid" placeholder="邀请码" value="<?php echo $_smarty_tpl->tpl_vars['superioruid']->value;?>
...
<?php echo '<script'; ?>
 type="text/javascript">
	$('#codeusername,#password,#passwordtwo,#superioruid').keyup(function(){
		if ($('#codeusername').val() && $('#password').val() && $('#passwordtwo').val() && $('#superioruid').val()){
...
>
	$(document).ready(function () {
		...
		$("#submits").click(function () {
			var options = {
				url: "<?php echo WSURLSHOW($_smarty_tpl->tpl_vars['WsCtrlClass']->value,'regform');?>
",
				type: 'post',
				dataType: 'text',
				...
				success: function (data) {
					if (data.length > 0) {
						if (data == "1003") {
							...
							setTimeout(function(){
								self.location = "<?php echo WSURLSHOW($_smarty_tpl->tpl_vars['WsCtrlClass']->value,'login');?>
";
							},3000);
						}
						if (data == "1004") {
